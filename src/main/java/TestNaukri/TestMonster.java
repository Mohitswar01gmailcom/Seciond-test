...
public class TestMonster {
	...
	// Open browser
	    ...
	    driver.findElement(By.xpath("//input[@placeholder='E-mail/Mobile']")).sendKeys("maheshshivramwar01@gmail.com");
	    ...
	    driver.findElement(By.xpath("//*[@id='profileThemeDefault']/div[1]/div[2]/div[6]/div/div/footer/div[2]/div"));
