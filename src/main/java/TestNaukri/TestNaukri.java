...
public class TestNaukri {
	...
	driver.findElement(By.xpath("//input[@placeholder='Enter your active Email ID / Username']")).sendKeys("maheshshivramwar01@gmail.com");
	...
	driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	driver.findElement(By.xpath("//*[@id='attachCV']")).sendKeys("D://RESUME//Mahesh_Shivramwar_Resume_Automation_Manual Testing _6.0 Years Pune.doc");
	//driver.close();
